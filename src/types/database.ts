  ...
  public: {
    ...
    Functions: {
      ...
      meeting_point_set_default: {
        Args: { p_meeting_point: string }
        Returns: undefined
      }
      mooves_amount_for_band: {
        Args: { p_band: Database["public"]["Enums"]["distance_band"] }
        Returns: number
      }
      ...
      trip_meeting_point_in_hub: {
        Args: { p_hub: string; p_mp: string }
        Returns: boolean
      }
      trip_request_first_contact: {
    ...
    Enums: {
      ...
      consent_type:
        ...
        | "photo_enfant"
      distance_band: "courte" | "moyenne" | "longue"
      household_role:
        | "parent"
        | "beau_parent"
        | "grand_parent"
